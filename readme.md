...
Cobblemon: Generation Spawns is a Minecraft mod designed to manage and restrict Pokémon spawning behavior in your game world.
...
- **Debugging Commands:** Allows users to keep track of the active generations and currently stored generations in both cache and persistent storage.
...
3. This background update immediately recalculates pool weights and constraints for Cobblemon's `/checkspawns` command. Players running `/checkspawns` will instantly see the updated pools, odds, and legal species reflecting the active generations.
